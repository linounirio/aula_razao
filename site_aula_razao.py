...
def aplicacao():
    ...
    st.markdown("""
                ...
                b. Vocês vão jogar (futebol, volei, basquete, queimado, etc) e passam no Multimix
                para comprar um refrigerante, só que vocês querem escolher o refrigerante
                que mais curtem beber, mas querem pagar mais barato, como farão essa escolha? E quanto cada um vai pagar?
                
                c. Vocês vão jogar (futebol, volei, basquete, queimado, etc) e passam no Multimix 
                para comprar um refrigerante, só que dessa vez um dos amigos assume que vai beber mais 
                e aceita pagar mais por isso, se ele bebe o dobro 
                de refrigerante do restante quanto ele pagará e quanto os outros pagarão a partir 
...
def conceito():
    ...
    with tab2:
        ...
        st.table(df_refri)
        texto_solucao_a = r'''
        O refrigerante escolhido foi o Kuat guarana 2lts, cada amigo vai $\frac{4.99}{4.0}$~1.25.
        '''
